# classifier/yolo_v8.py: This script is used to train and test the YOLOv8 model as classification model.
import ultralytics
import torch
import hydra
...
def train(cfg: DictConfig):
    ...
    results = model.train(
        # device=2,
        data="/mnt/aix22301/onj/dataset/v0/YOLO_CLS_PA",
        epochs=1000,
        batch=-1,
        imgsz=list(imgsz),
        # scale=0.0,
