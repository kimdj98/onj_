...
class ResNet18_2D(nn.Module):
    def __init__(self):
        ...
        self.fc = nn.Linear(512, 1) # use only the backbone of ResNet18
...
class ResNet3D(nn.Module):
    ...
    def forward(self, x):
        ...
        x1 = self.layer1(x)  # conv2_x
        x2 = self.layer2(x1)  # conv3_x
        x3 = self.layer3(x2)  # conv4_x
        x4 = self.layer4(x3)  # conv5_x
